...
void UsuarioManager::MostrarUsuarios(){
    ...
    for(int i=0; i<cantReg; i++){
        ...
        cuadro.escribirFila(reg[i].getFechaNac().toString(),3);
        cuadro.escribirFila(reg[i].getFechaIn().toString(),4);
...
void UsuarioManager::BajaUsuario(){
    ...
    terminal.mostrarTexto(reg.getFechaNac().toString(),posx+20,posy+6);
    terminal.mostrarTexto("Fecha Ingreso:....",posx,posy+8);
    terminal.mostrarTexto(reg.getFechaIn().toString(),posx+20,posy+8);
